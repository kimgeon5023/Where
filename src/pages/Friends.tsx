...
export default function Friends() {
  ...
  const load = useCallback(async () => {
    if (!user) return
    try {
      const [usersResult, friendsResult, notificationsResult] = await Promise.all([getSocialUsers(user.id), getFriends(user.id), getNotifications(user.id)])
