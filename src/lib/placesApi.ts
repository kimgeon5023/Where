...
export type PlaceSearchParams = { area?: string; category?: Category; companion?: Companion; headcount?: number; q?: string; tags?: Tag[]; includeLodging?: boolean; maxPrice?: number; page?: number; limit?: number; lat?: number; lng?: number; radius?: number; south?: number; north?: number; west?: number; east?: number; zoom?: number }
